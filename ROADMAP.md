...
Last groomed: 2026-08-01 (v0.31.0) — a packaging test fails the build if this stamp lags the
...
- **Whether a version gap between the running binary and the mission ever changes a verdict.**
  ...
  2026-07-31: the same working tree judged by `0.19.0` and `0.31.0` — the runward mission itself,
  then a mission freshly scaffolded by `0.31.0` — produced **byte-identical output except the header
