...
// that validates against the vendored NIST OSCAL 1.2.3 schema. Runs offline.
...
const SCHEMA_PATH = join(ROOT, "test", "fixtures", "oscal_component_schema.v1.2.3.json");
...
try {
  ...
  assert(ok, "OSCAL export validates against the NIST OSCAL 1.2.3 component-definition schema");
