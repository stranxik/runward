...
**Version**: v0.16.0 · **Last review**: 2026-07-16 · **Agent privilege level**: not applicable — runward is not an agent; it is a deterministic CLI with no model, no network, and no autonomy
