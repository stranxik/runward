...
**Date**: 2026-07-19 · **Version**: v0.20.0 · **Framing note**: [framing.md](framing.md) · **ADR journal**: [../docs/adr/](../docs/adr/) (see [adr/ADR-0001](adr/ADR-0001-decision-journal-lives-in-docs-adr.md))
...
| process-adr-and-journal | applied | 32 accepted product ADRs, each dated with a trigger to revisit — file:docs/adr/ADR-0001-enforce-declared-rule-conformance-at-the-gate.md; file:docs/adr/ADR-0024-machine-surface-of-the-rule-set.md; mission bridge: file:runward/adr/ADR-0001-decision-journal-lives-in-docs-adr.md |
