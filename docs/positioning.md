...
- EU AI Act: high-risk (Annex III/IV) obligations were postponed by the Digital Omnibus on AI (June 2026) to **2 December 2027** — do NOT market an "August 2026 high-risk deadline" (stale). The 2 August 2026 milestone still applies to Article 50 transparency, governance and GPAI enforcement. Do NOT say "the AI Act starts in 2026" (prohibitions since Feb 2025, GPAI since Aug 2025). Two current, durable talking points instead: FedRAMP RFC-0024 forbids GenAI-produced factual telemetry as evidence (a federal validation of the deterministic, zero-LLM gate), and the Delve affair (AI-prefilled SOC 2 audits) shows why AI-produced evidence is not trusted.
