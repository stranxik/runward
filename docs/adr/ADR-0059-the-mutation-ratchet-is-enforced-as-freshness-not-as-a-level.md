...
| 2. proven red on a falsified register | **yes**, closed 2026-08-26 — see the ratification section below | Locally, two falsifications each reverted: a verdict row removed → exit 1; a `stableKey` altered → exit 1; restored → exit 0 both times. In CI, the pair the criterion asks for: run 32991880465 on `c3932e81` (was `d03448bb` before the [2026-09-24 history rewrite](../compliance/history-rewrite-2026-09-24.md)) reads `1 survivor(s) the register does not carry` and exits 1; run 32986780418 on `0c7e4d3b` (was `8393e0b6` before the [2026-09-24 history rewrite](../compliance/history-rewrite-2026-09-24.md)) reads *the register describes this tree* and exits 0. The CI run this line originally owed also refuted decision 4's sizing, which is the amendment of 2026-08-25. |
...
| --- | --- | --- | --- | --- |
| red | [32991880465](https://github.com/stranxik/runward/actions/runs/32991880465) | `c3932e81` (was `d03448bb` before the [2026-09-24 history rewrite](../compliance/history-rewrite-2026-09-24.md)) | 213 rows, one removed | 38 of 38 chunks, 8 timeouts verified, **`1 survivor(s) the register does not carry`**, `MISMATCH`, exit 1 |
| green | [32986780418](https://github.com/stranxik/runward/actions/runs/32986780418) | `0c7e4d3b` (was `8393e0b6` before the [2026-09-24 history rewrite](../compliance/history-rewrite-2026-09-24.md)) | 214 rows, restored | 38 of 38 chunks, 8 timeouts verified, *the register describes this tree*, exit 0 |
